...
import { MdPlayCircle, MdTune } from 'react-icons/md'
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between mb-8">
            ...
            <button className="p-3 transition-all border rounded-full bg-white/5 border-white/10 hover:bg-white/10">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="group relative overflow-hidden rounded-2xl aspect-[4/3] cursor-pointer backdrop-blur-lg bg-white/5 border border-white/10">
