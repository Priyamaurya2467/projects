  ...
  return (
    ...
    <div className='flex flex-row justify-evenly rounded-4xl px-2 '>
        {card.map((item,index)=>(
            ...
            <div className='group flex flex-col gap-1 p-4 px-5 bg-white w-60 rounded-4xl shadow-sm transition-all duration-500 hover:shadow-[0_20px_40px_rgba(168,85,247,0.25)] hover:-translate-y-1' key={index}>
