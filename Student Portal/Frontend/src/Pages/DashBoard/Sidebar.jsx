...
function Sidebar() {
  ...
  return (
    ...
    <div className='w-64 h-screen p-5  py-10 flex flex-col justify-between'>
        ...
        {sideBarContent.map((item,index)=>(
                ...
                <div 
                key={index}
                className='flex  items-center p-2 gap-3 text-gray-500 font-semibold text-m py-5 px-3 hover:text-black'>{item.icon}{item.content}</div>
        ...
        <div className='space-y-4 px-5'>
            ...
            <div className='flex items-center gap-3 text-gray-500 p-2 font-semibold hover:text-red-500 cursor-pointer hover:bg-red-50 hover:rounded-2xl hover:p-2'>
